...
public class kachestvo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kachestvo);

        // Инициализация VideoView из макета
        videoView = findViewById(R.id.videoView);

        // Установка пути к видеофайлу
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.deff; // замените на ваше видео
    ...
    public void deff(View v) {
        String url = "https://github.com/Avar1tia/DeffectPy"; // замените на вашу ссылку
