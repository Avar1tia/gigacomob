...
public class colors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.color; // замените на ваше видео
    ...
    public void color(View v) {
        String url = "https://github.com/Avar1tia/ColorPy"; // замените на вашу ссылку
